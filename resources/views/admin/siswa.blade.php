                ...
                <div class="panel-body">
                            ...
                            <table id="absensi" class="table table-bordred table-striped">
                                ...
                                <tbody id="isi">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><p data-placement="top" data-toggle="tooltip" title="Edit">
                                        ...
                                        <td class="text-center"><p data-placement="top" data-toggle="tooltip" title="Delete">
                    ...
                    <div class="panel-footer">
                        <p data-placement="top" data-toggle="tooltip" title="Add" class="pull-right">
                            <button class="btn btn-primary btn-sm" data-title="Add" data-toggle="modal" data-target="#add" >
