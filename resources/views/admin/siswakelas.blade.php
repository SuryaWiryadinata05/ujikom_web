    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Data Siswa Kelas</div>
                            ...
                            <table id="absensi" class="table table-bordred table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><form action="{{url('/siswakelas/')}}" method="POST"><input type="hidden" name="kelas" value="{{$kelas}}"><input type="hidden" name="siswa" value="{{$res->id_siswa}}">
